	...
	<div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-lg-11">
	                    <?php echo form_open('c_admin/editkknp/'.$hasil->id_kknp , 'class="form-horizontal"'); ?>
						<div class="form-group">
					    	<label for="id dosen" class="col-lg-3 control-label">NIM Awal [<?php echo $hasil->nim ?>] </label>
					    	<div class="col-lg-6">
					 	...
					 	<div class="form-group">
					    	<label for="id dosen" class="col-lg-3 control-label">Pengajuan Awal: [<?php echo $hasil->id_pengajuan ?>]</label>
					    	<div class="col-lg-6">
					    		<select class="form-control" name="id_pengajuan" id="id_pengajuan" >
									...
									?>
							    	<option value="<?php echo $data->id_pengajuan ?>">
					 	...
					 	<div class="form-group">
					    	<label for="id dosen" class="col-lg-3 control-label">Dosen Awal: [<?php echo $hasil->id_dosen ?>]</label>
					    	<div class="col-lg-6">
					    		<select class="form-control" name="id_dosen" id="id_dosen" >
							    	...
							    	<option value="<?php echo $data->id_dosen ?>">
							    		[<?php echo $data->id_dosen ?>]
							    		[<?php echo $data->nm_dosen ?>]
							    	</option>
							    	<?php endforeach ?>
					    		</select>
					    	</div>
					 	...
					 	<div class="form-group">
					    	<label for="id dosen" class="col-lg-3 control-label">Status Awal: [<?php echo $hasil->id_status ?>]</label>
					    	<div class="col-lg-6">
