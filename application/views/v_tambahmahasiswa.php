	...
	<div class="row">
		...
		<div class="col-md-9 column">
    		...
    		<legend>Tambah Data MAHASISWA</legend>
				<form class="form-horizontal" role="form" action='<?= base_url();?>index.php/c_admin/tambahmahasiswa' method="post">
				 <div class="form-group">
				    <label for="id pengajuan" class="col-lg-3 control-label">NIM</label>
				    <div class="col-lg-6">
				      <input type="text" class="form-control" name="nim" id="nim" placeholder="Masukkan Nama Perusahaan">
				    </div>
				 </div>
				 <div class="form-group">
				    <label for="nim mahasiswa" class="col-lg-3 control-label">Nama Mahasiswa</label>
				    <div class="col-lg-6">
				      <input type="text" class="form-control" name="nm_mhs" id="nm_mhs" placeholder="Masukkan NIM">
				    </div>
				 </div>
				 <div class="form-group">
				    <label for="id dosen" class="col-lg-3 control-label">Jurusan</label>
				    <div class="col-lg-6">
				    	<select class="form-control" name="id_jurusan" id="id_jurusan">
							...
							?>
					    	<option><?php echo $data->id_jurusan ?></option>
					    	<?php endforeach ?>
				    	</select>
				    </div>
				 </div>
