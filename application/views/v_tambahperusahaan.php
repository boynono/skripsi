        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-lg-11">
	                    <fieldset>
							<form class="form-horizontal" role="form" action='<?= base_url();?>index.php/c_admin/tambahperusahaan' method="post">
							 <div class="form-group">
							    <label for="id pengajuan" class="col-lg-3 control-label">Nama Perusahaan</label>
							    <div class="col-lg-6">
							      <input type="text" class="form-control" name="nm_perusahaan" id="nm_perusahaan" placeholder="Masukkan Nama Perusahaan">
							    </div>
							 </div>
							 <div class="form-group">
							    <label for="nim mahasiswa" class="col-lg-3 control-label">Alamat Perusahaan</label>
							    <div class="col-lg-6">
							      <textarea class="form-control" name="alamat" id="alamat" placeholder="Masukkan NIM"></textarea>
							    </div>
							 </div>
							 <div class="form-group">
