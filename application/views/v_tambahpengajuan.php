...
<div class="container-full">
	...
	<div class="row">
		...
		<div class="col-md-9 column">
			<fieldset>
    		<legend>Tambah Data Pengajuan</legend>
				<form class="form-horizontal" role="form" action='<?= base_url();?>index.php/c_admin/tambahpengajuan' method="post">
				 <div class="form-group">
				    <label for="id pengajuan" class="col-lg-3 control-label">Objek</label>
				    <div class="col-lg-6">
				      <input type="text" class="form-control" name="objek" id="objek" placeholder="Objek">
				    </div>
				 </div>
				 <div class="form-group">
				    <label for="nim mahasiswa" class="col-lg-3 control-label">Tanggal Mulai</label>
				    <div class="col-lg-6">
				      <input type="text" class="form-control" name="tanggal_mulai" id="tanggal_mulai" placeholder="Tanggal Mulai">
				    </div>
				 </div>
				 <div class="form-group">
				    <label for="nim mahasiswa" class="col-lg-3 control-label">Tanggal Selesai</label>
				    <div class="col-lg-6">
				      <input type="text" class="form-control" name="tanggal_selesai" id="tanggal_selesai" placeholder="Tanggal Selesai">
				    </div>
				 </div>
				 <div class="form-group">
				 ...
				 <div class="form-group">
				    <div class="col-lg-offset-3 col-lg-10">
				      <button type="submit" class="btn btn-success">Save</button> <a href="<?= base_url();?>index.php/c_admin/lihattawaran" class="btn btn-primary">Cancel</a>
				    </div>
				 </div>
				</form>
			</fieldset>
