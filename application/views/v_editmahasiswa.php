	...
	<div class="row">
		...
		<div class="col-md-9 column">
			<legend>edit peserta</legend>
				<?php echo form_open('c_admin/editmahasiswa/'.$hasil->nim , 'class="form-horizontal"'); ?>
					<div class="form-group">
				    	<label for="nim" class="col-lg-3 control-label">NAMA</label>
				    	<div class="col-lg-6">
				      	<input type="text" class="form-control" name="nm_mhs" value="<?php echo $hasil->nm_mhs; ?>" placeholder="Nim Mahasiswa">
				    	</div>
				  	</div>		
					<div class="form-group">
