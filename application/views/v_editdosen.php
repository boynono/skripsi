	...
	<div class="row">
		...
		<div class="col-md-9 column">
			<legend>Edit Dosen</legend>
				<?php echo form_open('c_admin/editdosen/'.$hasil->id_dosen , 'class="form-horizontal"'); ?>
					<div class="form-group">
				    	<label for="nim" class="col-lg-3 control-label">Nama</label>
				    	<div class="col-lg-6">
				      	<input type="text" class="form-control" name="nm_dosen" value="<?php echo $hasil->nm_dosen; ?>" placeholder="Nim Mahasiswa">
				    	</div>
				  	</div>		
				  <div class="form-group">
				    <label for="nama" class="col-lg-3 control-label">Email</label>
				    <div class="col-lg-6">
				      <input type="text" class="form-control" name="email" value="<?php echo $hasil->email; ?>" placeholder="Nama Mahasiswa">
				    </div>
				  </div>
				  <div class="form-group">
				    <label for="jurusan" class="col-lg-3 control-label">Kontak</label>
				    <div class="col-lg-6">
