...
<div class="container-full">
	...
	<div class="row">
		...
		<div class="col-md-9 column">
			<fieldset>
    		<legend>Tambah Data KKNP</legend>
				<form class="form-horizontal" role="form" action='<?= base_url();?>index.php/c_admin/tambahkknp' method="post">
				 <div class="form-group">
				    	<label for="id dosen" class="col-lg-3 control-label">NIM</label>
				    	<div class="col-lg-6">
				    		<select class="form-control" name="nim" id="nim" >
								...
								?>
						    	<option><?php echo $data->nim ?></option>
						    	<?php endforeach ?>
				    		</select>
				    	</div>
				 	</div>
				 	<div class="form-group">
				    	<label for="id dosen" class="col-lg-3 control-label">Pengajuan</label>
				    	<div class="col-lg-6">
				    		<select class="form-control" name="id_pengajuan" id="id_pengajuan" >
								...
								?>
						    	<option><?php echo $data->id_pengajuan ?></option>
						    	<?php endforeach ?>
				    		</select>
				    	</div>
				 	</div>
				 	<div class="form-group">
				    	<label for="id dosen" class="col-lg-3 control-label">Dosen</label>
				    	<div class="col-lg-6">
				    		<select class="form-control" name="id_dosen" id="id_dosen" >
								...
								?>
						    	<option><?php echo $data->id_dosen ?></option>
						    	<?php endforeach ?>
				    		</select>
				    	</div>
				 	</div>
				 	<div class="form-group">
				    	<label for="id dosen" class="col-lg-3 control-label">Status</label>
				    	<div class="col-lg-6">
				    		<select class="form-control" name="id_status" id="id_status" >
								...
								?>
						    	<option><?php echo $data->id_status ?></option>
						    	<?php endforeach ?>
				    		</select>
				    	</div>
				 	</div> 	
