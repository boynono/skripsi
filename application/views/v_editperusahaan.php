	...
	<div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-lg-11">
	                    <?php echo form_open('c_admin/editperusahaan/'.$hasil->id_perusahaan , 'class="form-horizontal"'); ?>
						<div class="form-group">
						    	<label for="nim" class="col-lg-3 control-label">Nama Perusahaan</label>
						    	<div class="col-lg-6">
						      	<input type="text" class="form-control" name="nm_perusahaan" value="<?php echo $hasil->nm_perusahaan; ?>" placeholder="Nim Mahasiswa">
						    	</div>
						</div>		
						<div class="form-group">
						    <label for="nama" class="col-lg-3 control-label">Alamat</label>
						    <div class="col-lg-6">
						      <textarea class="form-control" name="alamat"  placeholder="Nama Mahasiswa"><?php echo $hasil->alamat; ?></textarea>
						    </div>
						</div>
						<div class="form-group">
						    <label for="jurusan" class="col-lg-3 control-label">Email Perusahaan</label>
						    <div class="col-lg-6">
						      <input type="text" class="form-control" name="email" value="<?php echo $hasil->email; ?>" placeholder="Jurusan">
						    </div>
						</div>
						<div class="form-group">
						    <label for="jurusan" class="col-lg-3 control-label">Kontak Perusahaan</label>
						    <div class="col-lg-6">
						      <input type="text" class="form-control" name="kontak" value="<?php echo $hasil->kontak; ?>" placeholder="Jurusan">
						    </div>
						</div>
						<div class="form-group">
